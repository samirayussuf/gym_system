...
if(isset($_POST["btn_mail"]))
{
  extract($_POST);
   ...
   $q1="UPDATE `tbl_email_config` SET `email_setting`='$email_setting',`mail_driver_host`='$mail_driver',`mail_port`='$mail_port' ,`mail_username`='$mail_username',`mail_password`='$mail_password',`mail_encrypt`='$mail_encryption'";
  $q2=$conn->query($q1);
  ?>
  <script>
                                ...
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST">
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Email Settings</label>
                                                <div class="col-sm-9">
                                                    <input type="text"  value="<?php echo $email_setting;?>"  name="email_setting" class="form-control">
                                                </div>
                                            </div>
                                        </div>
