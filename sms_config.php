...
if(isset($_POST["btn_sms"]))
{
  ...
  echo $q1="UPDATE `tbl_sms_config` SET `senderid`='$sender_id',`sms_username`='$sms_username',`sms_password`='$sms_password',`auth_key`='$auth_key'";
  ?>
  <script>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" value="<?php echo $sms_password;?>"  name="sms_password" class="form-control">
                                                </div>
                                            </div>
                                        </div>
