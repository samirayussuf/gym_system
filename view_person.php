  ...
  <!-- Page wrapper  -->
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- /# row -->
                 <div class="card">
                            ...
                            <a href="add_person.php"><button class="btn btn-primary">Add Users</button></a>
                          <?php } } ?>
            ...
            <?php if(isset($useroles)){  if(in_array("edit_user",$useroles)){ ?> 
                                                <a href="edit_person.php?id=<?=$row['id'];?>"><button type="button" class="btn btn-xs btn-primary" ><i class="fa fa-pencil"></i></button></a>
                                              <?php } } ?>

            <?php if(isset($useroles)){  if(in_array("delete_user",$useroles)){ ?> 
                                                <a href="del_person.php?id=<?=$row['id'];?>"><button type="button" class="btn btn-xs btn-danger" ><i class="fa fa-trash"></i></button></a>
                                              <?php } } ?>
